# LabelMaster / PackLabel — AWS DevOps Case Study
...
[Read more about the database approach](database.md)
...
[Read more about security](security.md) and [operability](sre-operability.md)
