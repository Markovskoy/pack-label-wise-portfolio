...
<div class="link-row">
  <a class="md-button md-button--primary" href="https://github.com/Markovskoy/pack-label-wise-portfolio">View GitHub Repository</a>
  <a class="md-button" href="https://potaglab.com">Open Production Website</a>
</div>
...
[Read more about the architecture](architecture.md){ .md-button .nav-button }
...
[Read more about CI/CD](cicd.md){ .md-button .nav-button }
...
[Read more about the database approach](database.md){ .md-button .nav-button }
...
[Read more about security](security.md){ .md-button .nav-button } [Read more about operability](sre-operability.md){ .md-button .nav-button }
